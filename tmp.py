...
# #     plt.show()
# #
# # path=r'CourseCV/img.png'
# # img1=cv2.imread(path,flags=0)
# # img2=img1/255.0+56
# # # pltimg(img1,img2)
# # plt.imshow(img1)
# # plt.show()
...
#
#
# def matplotlib_multi_pic1(*imgx):
#     plt.figure(figsize=(80,60),dpi=150)
#     for i in range(2):
#         # v=list(imgx[i])
#         # img = cv2.imread(v,flags=0)
#         # print(type(v),'\t',type(v),v.shape)
#         # img=Image.open('CourseCV/img.png').convert('L')
#         title="title"+str(i+1)
#         #行，列，索引
#         plt.subplot(1,2,i+1)
#         plt.imshow(imgx[i])
...
#         plt.xticks([])
#         plt.yticks([])
#         print(type(imgx),'\t',type(imgx[i]),imgx[i].shape)
#     plt.show()
#
# # path1='CourseCV/img.png'
# # path2='CourseCV/px.png'
# # img1=cv2.imread(path1)
# # img2=cv2.imread(path2)
# # # img=[img1,img2]
# # matplotlib_multi_pic1(img1,img2)
# # matplotlib_multi_pic1(img1,img2,img3,img4)
#
# # img=Image.open('CourseCV/img.png').convert('L')
# # img=Image.open('CourseCV/img.png')
# # plt.imshow(img)
# #
# # plt.show()
#
...
# import torch
# import numpy as np
# x=np.random.randint(0,100,(3,4,2,2))
# print("x:'\t'",x)
# y=x[0:1,1:2,:,:]
# print("y:'\t'",y)
# z=np.reshape(y,(1,2,2))
# print("z:'\t'",z)

import cv2 as cv
import numpy as np
from torch.utils.tensorboard import SummaryWriter
x=np.random.randint(0,256,(3,256,256),dtype=np.uint8)
# print(np.amax(x))     # 注意这里用amax
wter=SummaryWriter('./DL_Course/tmp_test/')
# wter.add_image('x',x,0,dataformats='CHW')
img=cv.imread(r'./Datas/pic/wang.jpg')
print(np.shape(img))
wter.add_image('wzx',img,0,dataformats='HWC')